...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>easyRFM/README.Rmd at master · etravelBI/easyRFM · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4D96:74EC151:551055EB" name="octolytics-dimension-request_id" />
...
<meta content="ustUSxuXP8LTmGM8gDmt/4VaT0HG6rTb5f711JMwZ0z4dk82MKCKNPVZMseGMXwknaVwI8s4z6usaGd3DW/PBw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2FetravelBI%2FeasyRFM%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/etravelBI/easyRFM/blob/d84d64934e29f06612574aa571cad982c916dd10/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:e7d2b98c6c7f738839d400f1827591bf -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/etravelBI/easyRFM/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/etravelBI/easyRFM/tree/0.1.0/README.Rmd"
                 data-name="0.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
...
<include-fragment class="commit commit-loader file-history-tease" src="/etravelBI/easyRFM/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/etravelBI/easyRFM/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/etravelBI/easyRFM/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/etravelBI/easyRFM/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
  ...
  <tbody>
  <tr>
  <td><div>easyRFM - An easy way to RFM analysis by R</div></td>
...
</table><pre lang="r,"><code>knitr::opts_chunk$set(echo=TRUE, warning=FALSE, message=FALSE)
</code></pre>
...
<pre lang="r,"><code>library(easyRFM)
...
<pre lang="r,"><code>data &lt;- rfm_generate_data(seed=123)
...
<pre lang="r,"><code>library(stringr)
data &lt;- rfm_generate_data(seed=123)
...
<span class="pl-smi">result</span><span class="pl-k">$</span>get_table(<span class="pl-s"><span class="pl-pds">"</span>RF<span class="pl-pds">"</span></span>, <span class="pl-v">M_slice</span><span class="pl-k">=</span><span class="pl-c1">4</span><span class="pl-k">:</span><span class="pl-c1">5</span>)

<span class="pl-smi">leaved_customers</span> <span class="pl-k">&lt;-</span> <span class="pl-smi">result</span><span class="pl-k">$</span>get_sliced_rfm(<span class="pl-v">R_slice</span><span class="pl-k">=</span><span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">2</span>, <span class="pl-v">F_slice</span><span class="pl-k">=</span><span class="pl-c1">2</span><span class="pl-k">:</span><span class="pl-c1">5</span>, <span class="pl-v">M_slice</span><span class="pl-k">=</span><span class="pl-c1">4</span><span class="pl-k">:</span><span class="pl-c1">5</span>)
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04015s from github-fe138-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
