...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>diffr/README.Rmd at master · petermeissner/diffr · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:54B8:86923F8:55104C69" name="octolytics-dimension-request_id" />
...
<meta content="HUBG23z6XFFs4SXeEaLTP8Y0r83j6JOU4ynBvM9DqrvOfS1LvEp8A+HAgG3QrXUCMw6Uw7uP6OuKwgJkRiL7lA==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fpetermeissner%2Fdiffr%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/petermeissner/diffr/blob/2de27bd0753aa8461f8384651f8d1e4bbf89850e/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:f92b7695c328967359dead0881b7864b -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/petermeissner/diffr/blob/0.1.1/README.Rmd"
               data-name="0.1.1"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/petermeissner/diffr/blob/0.1.2/README.Rmd"
               data-name="0.1.2"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/petermeissner/diffr/blob/going-for-0.1.3/README.Rmd"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/petermeissner/diffr/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<include-fragment class="commit commit-loader file-history-tease" src="/petermeissner/diffr/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/petermeissner/diffr/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/petermeissner/diffr/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/petermeissner/diffr/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,"><code>    devtools::install_github("petermeissner/diffr")
    require(diffr)
</code></pre>
...
<div class="highlight highlight-r"><pre>options(<span class="pl-v">width</span> <span class="pl-k">=</span> <span class="pl-c1">160</span>)</pre></div>

<div class="highlight highlight-r"><pre>    require(<span class="pl-smi">diffr</span>)

    <span class="pl-smi">res</span> <span class="pl-k">&lt;-</span> diffr(<span class="pl-smi">example_A1_split</span>, <span class="pl-smi">example_A2_split</span>, 
                 <span class="pl-v">clean</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>none<span class="pl-pds">"</span></span>, <span class="pl-v">dist</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>levenwords<span class="pl-pds">"</span></span>, <span class="pl-v">sortDF</span><span class="pl-k">=</span><span class="pl-c1">0</span>)

    names(<span class="pl-smi">res</span>)

    <span class="pl-c"># total difference between both texts:</span>
    sum(<span class="pl-smi">res</span><span class="pl-k">$</span><span class="pl-smi">alignment_df</span><span class="pl-k">$</span><span class="pl-smi">dist</span>, <span class="pl-v">na.rm</span><span class="pl-k">=</span><span class="pl-c1">T</span>)

    <span class="pl-c"># alignment of texts</span>
    head(<span class="pl-smi">res</span><span class="pl-k">$</span><span class="pl-smi">alignment_df</span>)

    <span class="pl-c"># alignment of texts with texts</span>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03518s from github-fe142-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
