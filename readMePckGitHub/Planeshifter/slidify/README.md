...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>slidify/README.md at master · Planeshifter/slidify · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:452A:DE8CD2:55103721" name="octolytics-dimension-request_id" />
...
<meta content="kPuFptgBzqhqWq7RJSAJcujlwfNsLubsQULlfRY0rwFkILCbDRhhnoIV3RmQpWIXt/R9koF1eX98tQA4BmR7fg==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2FPlaneshifter%2Fslidify%2Fblob%2Fmaster%2FREADME.md" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>

    <div class="site-search repo-scope js-site-search" role="search">
      <form accept-charset="UTF-8" action="/Planeshifter/slidify/search" class="js-site-search-form" data-global-search-url="/search" data-repo-search-url="/Planeshifter/slidify/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
  <input type="text"
...
<ul class="pagehead-actions">
  ...
  <li>
      <a href="/login?return_to=%2FPlaneshifter%2Fslidify"
    class="btn btn-sm btn-with-count tooltipped tooltipped-n"
    aria-label="You must be signed in to watch a repository" rel="nofollow">
    <span class="octicon octicon-eye"></span>
    Watch
  </a>
  <a class="social-count" href="/Planeshifter/slidify/watchers">
    1
  </a>
  ...
  <li>
    ...
    <a class="social-count js-social-count" href="/Planeshifter/slidify/stargazers">
      0
    </a>
    ...
    <li>
      ...
      <a href="/Planeshifter/slidify/network" class="social-count">
        177
      </a>
    </li>
</ul>
       ...
       --><strong><a href="/Planeshifter/slidify" class="js-current-repository" data-pjax="#js-repo-pjax-container">slidify</a></strong>
...
<nav class="sunken-menu repo-nav js-repo-nav js-sidenav-container-pjax js-octicon-loaders"
     ...
     data-issue-count-url="/Planeshifter/slidify/issues/counts">
  <ul class="sunken-menu-group">
    <li class="tooltipped tooltipped-w" aria-label="Code">
      <a href="/Planeshifter/slidify" aria-label="Code" class="selected js-selected-navigation-item sunken-menu-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches /Planeshifter/slidify">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pull requests">
      <a href="/Planeshifter/slidify/pulls" aria-label="Pull requests" class="js-selected-navigation-item sunken-menu-item" data-hotkey="g p" data-selected-links="repo_pulls /Planeshifter/slidify/pulls">
  ...
  <ul class="sunken-menu-group">
    ...
    <li class="tooltipped tooltipped-w" aria-label="Pulse">
      <a href="/Planeshifter/slidify/pulse" aria-label="Pulse" class="js-selected-navigation-item sunken-menu-item" data-selected-links="pulse /Planeshifter/slidify/pulse">
        <span class="octicon octicon-pulse"></span> <span class="full-word">Pulse</span>
        <img alt="" class="mini-loader" height="16" src="https://assets-cdn.github.com/assets/spinners/octocat-spinner-32-e513294efa576953719e4e2de888dd9cf929b7d62ed8d05f25e731d02452ab6c.gif" width="16" />
</a>    </li>

    <li class="tooltipped tooltipped-w" aria-label="Graphs">
      <a href="/Planeshifter/slidify/graphs" aria-label="Graphs" class="js-selected-navigation-item sunken-menu-item" data-selected-links="repo_graphs repo_contributors /Planeshifter/slidify/graphs">
...
<div class="clone-url open"
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini input-monospace js-url-field js-zeroclipboard-target"
           value="https://github.com/Planeshifter/slidify.git" readonly="readonly">
...
<div class="clone-url "
  ...
  <div class="input-group js-zeroclipboard-container">
    <input type="text" class="input-mini input-monospace js-url-field js-zeroclipboard-target"
           value="https://github.com/Planeshifter/slidify" readonly="readonly">
    <span class="input-group-button">
      <button aria-label="Copy to clipboard" class="js-zeroclipboard btn btn-sm zeroclipboard-button" data-copied-hint="Copied!" type="button"><span class="octicon octicon-clippy"></span></button>
    </span>
  </div>
...
<p class="clone-options">You can clone with
  ...
  <a href="https://help.github.com/articles/which-remote-url-should-i-use" class="help tooltipped tooltipped-n" aria-label="Get help on which URL is right for you.">
    <span class="octicon octicon-question"></span>
                ...
                <a href="/Planeshifter/slidify/archive/master.zip"
                   class="btn btn-sm sidebar-button"
                   aria-label="Download the contents of Planeshifter/slidify as a zip file"
                   title="Download the contents of Planeshifter/slidify as a zip file"
                   rel="nofollow">
...
<a href="/Planeshifter/slidify/blob/eeb493a24fc7f4b5707e4133f75ecc38ed046c70/README.md" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:79ca1d271b8f20373dd7bcee1c9d70cd -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/Planeshifter/slidify/blob/dev/README.md"
               data-name="dev"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/Planeshifter/slidify/blob/gh-pages/README.md"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/Planeshifter/slidify/blob/master/README.md"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Planeshifter/slidify/tree/v0.3.3/README.md"
                 data-name="v0.3.3"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Planeshifter/slidify/tree/v0.2.2/README.md"
                 data-name="v0.2.2"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="btn-group right">
    <a href="/Planeshifter/slidify/find/master"
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/Planeshifter/slidify" class="" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">slidify</span></a></span></span><span class="separator">/</span><strong class="final-path">README.md</strong>
  </div>
</div>

<include-fragment class="commit commit-loader file-history-tease" src="/Planeshifter/slidify/contributors/master/README.md">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/Planeshifter/slidify/raw/master/README.md" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/Planeshifter/slidify/blame/master/README.md" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/Planeshifter/slidify/commits/master/README.md" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03328s from github-fe134-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
