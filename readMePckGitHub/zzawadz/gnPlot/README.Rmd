...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>gnPlot/README.Rmd at master · zzawadz/gnPlot · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:452D:437F3A9:551044FE" name="octolytics-dimension-request_id" />
...
<meta content="YW+LGx3nxyavnePQLH+OEiES6LffpJhD0T3hIzYvYelOLGMav7vsDx6t8Mk5CBgZmCbwGXf/3eoRqhrH1KLlBg==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fzzawadz%2FgnPlot%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/zzawadz/gnPlot/blob/f0ed73b1793544fa62bb8c45ef316663edf7573e/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:b02c2800d2389214bf6c306b414fda82 -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/zzawadz/gnPlot/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/zzawadz/gnPlot" class="" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">gnPlot</span></a></span></span><span class="separator">/</span><strong class="final-path">README.Rmd</strong>
  </div>
</div>

<include-fragment class="commit commit-loader file-history-tease" src="/zzawadz/gnPlot/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/zzawadz/gnPlot/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/zzawadz/gnPlot/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/zzawadz/gnPlot/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,"><code>require(knitr)
require(gnPlot)
options("LAST_GN_DEVICE" = NULL)
options("LAST_GN_PLOTS" = NULL)

knit_hooks$set(hook_gnplot = hook_gnplot)
opts_chunk$set(cache = TRUE,fig.width = 6, fig.height = 3,results='hide', hook_gnplot = TRUE)
...
<pre lang="r,eval=FALSE"><code>require(devtools)
install_github("gnPlot", "zzawadz")
</code></pre>

<pre lang="r,eval=FALSE"><code>require(gnPlot)
</code></pre>
...
<pre lang="r,"><code>require(gnPlot)
g = gnInit()
g = g + gnXlab("XLAB")
g = g + gnScatterPlot(rnorm(100), rnorm(100))
gnRender(g)
</code></pre>

<pre lang="r,results='hide',"><code>g = g + gnScatterPlot(rnorm(200)+2, rnorm(200)+3,title = "Dataset 2")+ gnYlab("YLAB")
g
</code></pre>
...
<pre lang="r,warning=FALSE"><code>require(quantmod)
data = tail(getSymbols("^GSPC",auto.assign = FALSE),90)
gnCandlePlot(data)
</code></pre>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03073s from github-fe126-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
