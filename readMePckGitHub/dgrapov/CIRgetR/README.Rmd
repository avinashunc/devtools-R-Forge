...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>CIRgetR/README.Rmd at master · dgrapov/CIRgetR · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:54B5:4D68EB0:55103391" name="octolytics-dimension-request_id" />
...
<meta content="9IxDx5XQnmQk6W1KV8O9o4404U+Ot8h8uwnLfynQR1q0ilUI7f4IbYM1P5qUSZVQbUaBw9wzb4CGcKoLWdoYCg==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fdgrapov%2FCIRgetR%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/dgrapov/CIRgetR/blob/4c2e2b90d4d1e98d8dc87ab142da46d35a5c8f06/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:e4a383445c0d8c53c77933dd588522dd -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/dgrapov/CIRgetR/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/dgrapov/CIRgetR/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/dgrapov/CIRgetR/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/dgrapov/CIRgetR/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/dgrapov/CIRgetR/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,echo=FALSE,message=FALSE,"><code>install.packages("devtools");install.packages("RJSONIO")
...
<pre lang="r,message=FALSE,"><code>#test
...
<span class="pl-smi">gif</span> <span class="pl-k">&lt;-</span> read.gif(<span class="pl-smi">image.url</span>, <span class="pl-v">verbose</span> <span class="pl-k">=</span> <span class="pl-c1">TRUE</span>, <span class="pl-v">flip</span> <span class="pl-k">=</span> <span class="pl-c1">TRUE</span>)
par(<span class="pl-v">pin</span><span class="pl-k">=</span>c(<span class="pl-c1">3.5</span>,<span class="pl-c1">3.5</span>))
image(<span class="pl-smi">gif</span><span class="pl-k">$</span><span class="pl-smi">image</span>, <span class="pl-v">col</span> <span class="pl-k">=</span> <span class="pl-smi">gif</span><span class="pl-k">$</span><span class="pl-smi">col</span>, <span class="pl-v">main</span> <span class="pl-k">=</span>as.character(<span class="pl-smi">translations</span><span class="pl-k">$</span><span class="pl-smi">name</span>[<span class="pl-c1">1</span>]), <span class="pl-v">frame.plot</span><span class="pl-k">=</span><span class="pl-c1">FALSE</span>,<span class="pl-v">xaxt</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>n<span class="pl-pds">"</span></span>, <span class="pl-v">yaxt</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>n<span class="pl-pds">"</span></span>) 
</pre></div>
</article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04021s from github-fe116-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
