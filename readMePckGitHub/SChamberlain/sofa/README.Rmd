...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>sofa/README.Rmd at master · sckott/sofa · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:54B8:83535D2:55103306" name="octolytics-dimension-request_id" />
...
<meta content="zjc3yGW1s02rI0l37JynasgIuq0Dnas4U/VLx4SFN1UwxpJliFc+Bw3InLHMYAqDPd6LTn3VlrEwQoh5OBo/Lg==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fsckott%2Fsofa%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/sckott/sofa/blob/dde5b1a03e302539af5fcde0d5cf4b6dd1c67a5a/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:66ac9a4ef47733f9f87adf094acb59b3 -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/sckott/sofa/blob/gh-pages/README.Rmd"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/sckott/sofa/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/sckott/sofa/blob/s3methods/README.Rmd"
               data-name="s3methods"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/sckott/sofa" class="" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">sofa</span></a></span></span><span class="separator">/</span><strong class="final-path">README.Rmd</strong>
  </div>
</div>

<include-fragment class="commit commit-loader file-history-tease" src="/sckott/sofa/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/sckott/sofa/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/sckott/sofa/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/sckott/sofa/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div class="highlight highlight-r"><pre>ping()</pre></div>
...
<div class="highlight highlight-r"><pre><span class="pl-k">if</span>(is.null(db_info(<span class="pl-v">dbname</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>)<span class="pl-k">$</span><span class="pl-smi">error</span>)) db_delete(<span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>sofadb<span class="pl-pds">'</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>db_create(<span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>sofadb<span class="pl-pds">'</span></span>)</pre></div>

<p>see if its there now</p>

<div class="highlight highlight-r"><pre>db_list()</pre></div>
...
doc_create(<span class="pl-smi">doc1</span>, <span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>, <span class="pl-v">docid</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>a_beer<span class="pl-pds">"</span></span>)</pre></div>
...
doc_create(<span class="pl-smi">doc2</span>, <span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>)</pre></div>
...
doc_create(<span class="pl-smi">doc3</span>, <span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>, <span class="pl-v">docid</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>somexml<span class="pl-pds">"</span></span>)</pre></div>

<p>get the doc back out</p>

<div class="highlight highlight-r"><pre>doc_get(<span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>, <span class="pl-v">docid</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>somexml<span class="pl-pds">"</span></span>)</pre></div>

<p>get just the xml out</p>

<div class="highlight highlight-r"><pre>doc_get(<span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>, <span class="pl-v">docid</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>somexml<span class="pl-pds">"</span></span>)[[<span class="pl-s"><span class="pl-pds">"</span>xml<span class="pl-pds">"</span></span>]]</pre></div>
...
<div class="highlight highlight-r"><pre><span class="pl-k">if</span>(is.null(db_info(<span class="pl-v">dbname</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>sofadb<span class="pl-pds">"</span></span>)<span class="pl-k">$</span><span class="pl-smi">error</span>)) db_delete(<span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>sofadb<span class="pl-pds">'</span></span>)
<span class="pl-k">if</span>(is.null(db_info(<span class="pl-v">dbname</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>alm_couchdb<span class="pl-pds">"</span></span>)<span class="pl-k">$</span><span class="pl-smi">error</span>)) db_delete(<span class="pl-v">dbname</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>alm_couchdb<span class="pl-pds">'</span></span>)</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03258s from github-fe117-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
