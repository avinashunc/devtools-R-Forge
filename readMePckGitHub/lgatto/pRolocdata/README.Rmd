...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>pRolocdata/README.Rmd at master · lgatto/pRolocdata · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:54B4:332A3F0:5510313E" name="octolytics-dimension-request_id" />
...
<meta content="GgNdbE54CnrKC+59vwQi3lOPEePNSM9beSt8D52dKQyMEKUSUhl5I9apTmZgrrax8diXhTSU4Ow835LpVUzjbQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Flgatto%2FpRolocdata%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/lgatto/pRolocdata/blob/d0fe9c166f523524eb7077a415aa58a23f3ae548/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:baa86769f451d2d28ca52365d9f697cc -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/lgatto/pRolocdata/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lgatto/pRolocdata/tree/1.0.6/README.Rmd"
                 data-name="1.0.6"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lgatto/pRolocdata/tree/1.0.0/README.Rmd"
                 data-name="1.0.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lgatto/pRolocdata/tree/0.99.8/README.Rmd"
                 data-name="0.99.8"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lgatto/pRolocdata/tree/0.99.7/README.Rmd"
                 data-name="0.99.7"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lgatto/pRolocdata/tree/0.99.6/README.Rmd"
                 data-name="0.99.6"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lgatto/pRolocdata/tree/0.99.5/README.Rmd"
                 data-name="0.99.5"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
...
<include-fragment class="commit commit-loader file-history-tease" src="/lgatto/pRolocdata/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/lgatto/pRolocdata/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/lgatto/pRolocdata/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/lgatto/pRolocdata/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,"><code>source("http://bioconductor.org/biocLite.R")
biocLite("pRolocdata")
</code></pre>

<p>Once installed, the package needs to be loaded</p>

<pre lang="r,"><code>library("pRolocdata")
</code></pre>
...
<p>Currently, there are <code>r nrow(x)</code> datasets available in
<code>pRolocdata</code>. Use the <code>pRolocdata()</code> function to obtain a list of data
names and their description.</p>

<pre lang="r,"><code>pRolocdata()
</code></pre>

<pre lang="r,"><code>kable(x, format = "markdown")
</code></pre>
...
<div class="highlight highlight-r"><pre>experimentData(<span class="pl-smi">dunkley2006</span>)<span class="pl-k">@</span><span class="pl-smi">samples</span>
pubMedIds(<span class="pl-smi">dunkley2006</span>)
otherInfo(experimentData(<span class="pl-smi">dunkley2006</span>))

<span class="pl-c">## all at once</span>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.02638s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
