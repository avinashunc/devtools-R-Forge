...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>Rhiredis/README.Rmd at master · wush978/Rhiredis · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:54B5:4DA3A8C:551035AE" name="octolytics-dimension-request_id" />
...
<meta content="SIwMTPTgNzLMWIjRBTIHKNqeTYFEtdZlIKMmJlLJhzBjjNkoEe9UcU3/PKY/2rg7aSPnWOrk8WB78uHSEbALMg==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fwush978%2FRhiredis%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/wush978/Rhiredis/blob/e696f75944233a0306988ce4033c7d2c51911e75/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:deb12824d7f9602d7619830095c6f6ee -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/wush978/Rhiredis/blob/gen/README.Rmd"
               data-name="gen"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/wush978/Rhiredis/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wush978/Rhiredis/tree/prototype/README.Rmd"
                 data-name="prototype"
                 data-skip-pjax="true"
                 rel="nofollow"
...
<include-fragment class="commit commit-loader file-history-tease" src="/wush978/Rhiredis/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/wush978/Rhiredis/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/wush978/Rhiredis/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/wush978/Rhiredis/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
benchmark(
    <span class="pl-e">Rhiredis</span><span class="pl-k">::</span>redisSET(<span class="pl-s"><span class="pl-pds">"</span>a1<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>b1<span class="pl-pds">"</span></span>),
    <span class="pl-e">rredis</span><span class="pl-k">::</span>redisSet(<span class="pl-s"><span class="pl-pds">"</span>a2<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>b2<span class="pl-pds">"</span></span>)
)

<span class="pl-e">Rhiredis</span><span class="pl-k">::</span>redisGET(<span class="pl-s"><span class="pl-pds">"</span>a1<span class="pl-pds">"</span></span>)
<span class="pl-e">rredis</span><span class="pl-k">::</span>redisGet(<span class="pl-s"><span class="pl-pds">"</span>a2<span class="pl-pds">"</span></span>)</pre></div>
...
benchmark(
    <span class="pl-e">Rhiredis</span><span class="pl-k">::</span>redisSET(<span class="pl-s"><span class="pl-pds">"</span>a1<span class="pl-pds">"</span></span>, base64encode(serialize(<span class="pl-smi">iris</span>, <span class="pl-c1">NULL</span>))),
    <span class="pl-e">rredis</span><span class="pl-k">::</span>redisSet(<span class="pl-s"><span class="pl-pds">"</span>a2<span class="pl-pds">"</span></span>, <span class="pl-smi">iris</span>)
)

all.equal(unserialize(base64decode(<span class="pl-e">Rhiredis</span><span class="pl-k">::</span>redisGET(<span class="pl-s"><span class="pl-pds">"</span>a1<span class="pl-pds">"</span></span>))), <span class="pl-smi">iris</span>)
all.equal(<span class="pl-e">rredis</span><span class="pl-k">::</span>redisGet(<span class="pl-s"><span class="pl-pds">"</span>a2<span class="pl-pds">"</span></span>), <span class="pl-smi">iris</span>)</pre></div>
