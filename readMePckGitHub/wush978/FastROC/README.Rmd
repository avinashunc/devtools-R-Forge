...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>FastROC/README.Rmd at master · wush978/FastROC · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC101:6669:1B28044:55104F49" name="octolytics-dimension-request_id" />
...
<meta content="0T3+MNdM9IBPY1bC5xzrVI0BvZDjD07dK3cHAhNmdDDvceA/LXZVss0GCQNTSpPRURieU8B9c6NWk+CwtpLZiQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fwush978%2FFastROC%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/wush978/FastROC/blob/f1c0fe867765a010fb97d7849f07ca96f4fb0777/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:282648cd4016759dfb3213f21d5c2c50 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/wush978/FastROC/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/wush978/FastROC/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/wush978/FastROC/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/wush978/FastROC/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/wush978/FastROC/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
microbenchmark(
  <span class="pl-smi">auc.ROCR</span> <span class="pl-k">&lt;-</span> f.ROCR(),
  <span class="pl-smi">auc.FastROC</span> <span class="pl-k">&lt;-</span> f.FastROC(),
  <span class="pl-smi">auc.pROC</span> <span class="pl-k">&lt;-</span> f.pROC(),
  <span class="pl-smi">auc.caTools</span> <span class="pl-k">&lt;-</span> f.caTools()
  )

all.equal(<span class="pl-smi">auc.ROCR</span>, <span class="pl-smi">auc.FastROC</span>)
all.equal(<span class="pl-smi">auc.pROC</span>[<span class="pl-c1">1</span>], <span class="pl-smi">auc.FastROC</span>)
all.equal(<span class="pl-smi">auc.caTools</span>, <span class="pl-smi">auc.FastROC</span>)

<span class="pl-smi">n</span> <span class="pl-k">&lt;-</span> <span class="pl-c1">10</span><span class="pl-k">^</span><span class="pl-c1">4</span>
<span class="pl-smi">pred.x</span> <span class="pl-k">&lt;-</span> rnorm(<span class="pl-smi">n</span>)
<span class="pl-smi">true.x</span> <span class="pl-k">&lt;-</span> runif(<span class="pl-smi">n</span>) <span class="pl-k">&lt;</span> <span class="pl-c1">1</span> <span class="pl-k">/</span> (<span class="pl-c1">1</span> <span class="pl-k">+</span> exp(<span class="pl-k">-</span><span class="pl-smi">pred.x</span>))

microbenchmark(<span class="pl-v">times</span><span class="pl-k">=</span><span class="pl-c1">10</span>,
  <span class="pl-smi">auc.ROCR</span> <span class="pl-k">&lt;-</span> f.ROCR(),
  <span class="pl-smi">auc.FastROC</span> <span class="pl-k">&lt;-</span> f.FastROC(),
  <span class="pl-smi">auc.pROC</span> <span class="pl-k">&lt;-</span> f.pROC(),
  <span class="pl-smi">auc.caTools</span> <span class="pl-k">&lt;-</span> f.caTools()
...
print(<span class="pl-smi">auc.ROCR</span>)
print(<span class="pl-smi">auc.FastROC</span>)
print(<span class="pl-smi">auc.caTools</span>)

<span class="pl-smi">n</span> <span class="pl-k">&lt;-</span> <span class="pl-c1">10</span><span class="pl-k">^</span><span class="pl-c1">7</span>
<span class="pl-smi">pred.x</span> <span class="pl-k">&lt;-</span> rnorm(<span class="pl-smi">n</span>)
<span class="pl-smi">true.x</span> <span class="pl-k">&lt;-</span> runif(<span class="pl-smi">n</span>) <span class="pl-k">&lt;</span> <span class="pl-c1">1</span> <span class="pl-k">/</span> (<span class="pl-c1">1</span> <span class="pl-k">+</span> exp(<span class="pl-k">-</span><span class="pl-smi">pred.x</span>))
print(system.time(<span class="pl-smi">auc.ROCR</span> <span class="pl-k">&lt;-</span> f.ROCR()))
print(system.time(<span class="pl-smi">auc.FastROC</span> <span class="pl-k">&lt;-</span> f.FastROC()))</pre></div>
</article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03422s from github-fe143-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
