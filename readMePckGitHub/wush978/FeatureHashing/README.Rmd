...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>FeatureHashing/README.Rmd at master · wush978/FeatureHashing · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4D92:2DD3264:55104826" name="octolytics-dimension-request_id" />
...
<meta content="XTSSpgmihUf1oXLrsFYFO9NJK8ZE+kbkMBFg2JpBJyD6VyHIjkNboAkpu8neiL8YDzDyyKacr1EpqmtY7thPMQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fwush978%2FFeatureHashing%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/wush978/FeatureHashing/blob/6422a08896b0946be1ded45f9c32cc9ccea8b7b4/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:04869939228dd3f60ab13a7137c2bbc5 -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/wush978/FeatureHashing/blob/dev/0.9/README.Rmd"
               data-name="dev/0.9"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/wush978/FeatureHashing/blob/dev/0.9.1/README.Rmd"
               data-name="dev/0.9.1"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/wush978/FeatureHashing/blob/gh-pages/README.Rmd"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/wush978/FeatureHashing/blob/hotfix/61/README.Rmd"
               data-name="hotfix/61"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/wush978/FeatureHashing/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wush978/FeatureHashing/tree/slide-v1/README.Rmd"
                 data-name="slide-v1"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wush978/FeatureHashing/tree/cran-2015-01-01/README.Rmd"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/wush978/FeatureHashing/tree/cran-2014-12-22/README.Rmd"
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        ...
        <time datetime="2015-03-16T14:57:19Z" is="relative-time">Mar 16, 2015</time>
        <div class="commit-title">
            <a href="/wush978/FeatureHashing/commit/2289917de3cd9d46f71f42ab20a1401fe157cdba" class="message" data-pjax="true" title="add `the`
#58">add `the`</a>
        </div>
    </div>
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/wush978/FeatureHashing/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/wush978/FeatureHashing/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/wush978/FeatureHashing/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div class="highlight highlight-r"><pre>library(<span class="pl-smi">knitcitations</span>)
<span class="pl-smi">bib</span> <span class="pl-k">&lt;-</span> read.bibtex(<span class="pl-s"><span class="pl-pds">"</span>README.bib<span class="pl-pds">"</span></span>)
<span class="pl-c"># citep(bib[[1]])</span></pre></div>
...
<p>The package FeatureHashing implements the method in <code>r citep(bib[["DBLP:conf/icml/WeinbergerDLSA09"]])</code> to transform
...
<p>The dataset is a sample from iPinYou dataset which is described in <code>r citep(bib[["zhang2014real"]])</code>.</p>
...
library(<span class="pl-smi">FeatureHashing</span>)

<span class="pl-c"># Checking version.</span>
...
library(<span class="pl-smi">glmnet</span>)

<span class="pl-smi">cv.g.lr</span> <span class="pl-k">&lt;-</span> cv.glmnet(<span class="pl-smi">m.train</span>, <span class="pl-smi">ipinyou.train</span><span class="pl-k">$</span><span class="pl-smi">IsClick</span>,
...
<p>The following scripts use an implementation of the FTRL-Proximal for Logistic Regresion, which is published in <code>r citep(bib[["DBLP:conf/kdd/McMahanHSYEGNPDGCLWHBK13"]])</code>, to predict the probability (1-step prediction) and update the model simultaneously.</p>
...
<p>If we use the same algorithm to predict the click through rate of the 3rd season of iPinYou, the overall AUC will be 0.77 which is comparable to the overall AUC of the 3rd season 0.76 reported in <code>r citep(bib[["zhang2014real"]])</code>.</p>
...
<div class="highlight highlight-r"><pre>bibliography()</pre></div>
</article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.02791s from github-fe125-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
