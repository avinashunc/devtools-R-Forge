...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>regexr/README.Rmd at master · trinker/regexr · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4D97:422A3DB:55105613" name="octolytics-dimension-request_id" />
...
<meta content="wpuKZ596MGYTnPhaSfST7+zskSiwF3CfmZj9c/uKM7r6S76Qf7H6tNXlWb8hLjNr8cQzDNrlkQnJb0Haly7nVQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Ftrinker%2Fregexr%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/trinker/regexr/blob/1a30965363e6685121c3d9c2ff0b92e88eb36b75/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:b570dce13d6720544433d7e30a1ee55d -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/trinker/regexr/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/trinker/regexr/tree/regexrv.1.0.0initial/README.Rmd"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/trinker/regexr/tree/regexr_v.0.0.1/README.Rmd"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/trinker/regexr/tree/initial_v.0.0.2/README.Rmd"
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/trinker/regexr" class="" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">regexr</span></a></span></span><span class="separator">/</span><strong class="final-path">README.Rmd</strong>
  </div>
</div>

<include-fragment class="commit commit-loader file-history-tease" src="/trinker/regexr/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/trinker/regexr/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/trinker/regexr/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/trinker/regexr/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,"><code>desc &lt;- suppressWarnings(readLines("DESCRIPTION"))
...
<pre lang="r,"><code>library(regexr)
...
<div class="highlight highlight-r"><pre>subs(<span class="pl-smi">m</span>)
comments(<span class="pl-smi">m</span>)
names(<span class="pl-smi">m</span>)
subs(<span class="pl-smi">m</span>)[<span class="pl-c1">4</span>] <span class="pl-k">&lt;-</span> <span class="pl-s"><span class="pl-pds">"</span>(FO{2})|(BAR)<span class="pl-pds">"</span></span>
...
<div class="highlight highlight-r"><pre>test(<span class="pl-smi">m</span>)
subs(<span class="pl-smi">m</span>)[<span class="pl-c1">5</span><span class="pl-k">:</span><span class="pl-c1">7</span>] <span class="pl-k">&lt;-</span> c(<span class="pl-s"><span class="pl-pds">"</span>(<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>([A-Z]|(<span class="pl-cce">\\</span>d{5})<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>)<span class="pl-pds">"</span></span>)
...
(<span class="pl-smi">myregex</span> <span class="pl-k">&lt;-</span> grab(<span class="pl-s"><span class="pl-pds">"</span>@rm_time<span class="pl-pds">"</span></span>))
<span class="pl-smi">out</span> <span class="pl-k">&lt;-</span> as.regexr(<span class="pl-smi">myregex</span>)
...
<pre lang="r,"><code>get_construct(out)
</code></pre>
...
<pre lang="r,"><code>myregex2 &lt;- "(\\s*[a-z]+)([^)]+\\))"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.02836s from github-fe139-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
