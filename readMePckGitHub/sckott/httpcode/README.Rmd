...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>httpcode/README.Rmd at master · sckott/httpcode · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4D94:5AF8677:551053D5" name="octolytics-dimension-request_id" />
...
<meta content="rpqEPltfxl67yUDherEHiM+isAPocxhL/CUM2GlzTxAF/ZMuJxAXeFxg7ix/+tOyLAKe6FY87UzTcRicCFx+CA==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fsckott%2Fhttpcode%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/sckott/httpcode/blob/b1b76d9bb54a74c1e781486c6b3ab133093c9cad/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:5e5e7b22d3d3a4a1b67c8befd967000c -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/sckott/httpcode/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/sckott/httpcode/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/sckott/httpcode/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/sckott/httpcode/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/sckott/httpcode/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div class="highlight highlight-r"><pre>http_code(<span class="pl-c1">100</span>)</pre></div>

<div class="highlight highlight-r"><pre>http_code(<span class="pl-c1">400</span>)</pre></div>

<div class="highlight highlight-r"><pre>http_code(<span class="pl-c1">503</span>)</pre></div>

<div class="highlight highlight-r"><pre>http_code(<span class="pl-c1">999</span>)</pre></div>
...
<div class="highlight highlight-r"><pre>http_code(<span class="pl-s"><span class="pl-pds">'</span>1xx<span class="pl-pds">'</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>http_code(<span class="pl-s"><span class="pl-pds">'</span>3xx<span class="pl-pds">'</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>http_code(<span class="pl-s"><span class="pl-pds">'</span>30[12]<span class="pl-pds">'</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>http_code(<span class="pl-s"><span class="pl-pds">'</span>30[34]<span class="pl-pds">'</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>http_search(<span class="pl-s"><span class="pl-pds">"</span>request<span class="pl-pds">"</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>http_search(<span class="pl-s"><span class="pl-pds">"</span>forbidden<span class="pl-pds">"</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>http_search(<span class="pl-s"><span class="pl-pds">"</span>too<span class="pl-pds">"</span></span>)</pre></div>

<div class="highlight highlight-r"><pre>http_search(<span class="pl-s"><span class="pl-pds">"</span>birds<span class="pl-pds">"</span></span>)</pre></div>
</article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03770s from github-fe138-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
