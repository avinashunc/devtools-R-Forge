...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>ckanr/README.Rmd at master · ropensci/ckanr · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4530:77612A1:55105195" name="octolytics-dimension-request_id" />
...
<meta content="rbThJNT8sFnFxrKfI20RvnXfswA3mRT/BAaYGgBtln64Qam1nZKS5w4+ngdlYBo9eN6WiIK3usnh7K7v6D9bXA==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fropensci%2Fckanr%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/ropensci/ckanr/blob/8acaa48478f69af59e51f2eee4eb2b1bf1ccd325/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:8122d4371906a9b1c0abb909606c13ac -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/ropensci/ckanr/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ropensci/ckanr" class="" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">ckanr</span></a></span></span><span class="separator">/</span><strong class="final-path">README.Rmd</strong>
  </div>
</div>

<include-fragment class="commit commit-loader file-history-tease" src="/ropensci/ckanr/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/ropensci/ckanr/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/ropensci/ckanr/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/ropensci/ckanr/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div class="highlight highlight-r"><pre>changes(<span class="pl-v">limit</span> <span class="pl-k">=</span> <span class="pl-c1">2</span>, <span class="pl-v">as</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>table<span class="pl-pds">"</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>datasets(<span class="pl-v">as</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>table<span class="pl-pds">"</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>tag_list(<span class="pl-s"><span class="pl-pds">'</span>aviation<span class="pl-pds">'</span></span>, <span class="pl-v">as</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>table<span class="pl-pds">'</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>tag_show(<span class="pl-s"><span class="pl-pds">'</span>Aviation<span class="pl-pds">'</span></span>)<span class="pl-k">$</span><span class="pl-smi">packages</span>[[<span class="pl-c1">1</span>]][<span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">3</span>] </pre></div>
...
<div class="highlight highlight-r"><pre>group_list(<span class="pl-v">as</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>table<span class="pl-pds">'</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>group_show(<span class="pl-s"><span class="pl-pds">'</span>communications<span class="pl-pds">'</span></span>, <span class="pl-v">as</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>table<span class="pl-pds">'</span></span>)<span class="pl-k">$</span><span class="pl-smi">users</span></pre></div>
...
<span class="pl-smi">out</span>[, <span class="pl-k">!</span>names(<span class="pl-smi">out</span>) <span class="pl-k">%in%</span> <span class="pl-s"><span class="pl-pds">'</span>resources<span class="pl-pds">'</span></span>]</pre></div>
...
<div class="highlight highlight-r"><pre>resource_search(<span class="pl-v">q</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>name:data<span class="pl-pds">'</span></span>, <span class="pl-v">limit</span> <span class="pl-k">=</span> <span class="pl-c1">2</span>, <span class="pl-v">as</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>table<span class="pl-pds">'</span></span>)</pre></div>
...
package_list(<span class="pl-v">as</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>table<span class="pl-pds">"</span></span>, <span class="pl-v">url</span> <span class="pl-k">=</span> <span class="pl-smi">nhmbase</span>)</pre></div>

<p>List tags</p>

<div class="highlight highlight-r"><pre>tag_list(<span class="pl-v">as</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>table<span class="pl-pds">"</span></span>, <span class="pl-v">url</span> <span class="pl-k">=</span> <span class="pl-smi">nhmbase</span>)</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03479s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
