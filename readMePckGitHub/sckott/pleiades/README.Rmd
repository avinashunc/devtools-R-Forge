...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>pleiades/README.Rmd at master · ropensci/pleiades · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4D91:1BD3A8F:5510482C" name="octolytics-dimension-request_id" />
...
<meta content="sBJQ0GtppFM3L7tIFThSW9y+j5qRLJM+QfRPqNrby6JOIFEf2t5ueTnJ0pahhqq83UJFAq0Pq7nPc3JbGWzj0g==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fropensci%2Fpleiades%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/ropensci/pleiades/blob/9d8a662c1ee8b82c7ceaabc3afc7f2a815ca28a9/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:b49235370d04ee53663a3db2ef278274 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/ropensci/pleiades/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/ropensci/pleiades/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/ropensci/pleiades/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/ropensci/pleiades/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/ropensci/pleiades/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div class="highlight highlight-r"><pre>pl_status()</pre></div>
...
<div class="highlight highlight-r"><pre>pl_places(<span class="pl-v">place_id</span><span class="pl-k">=</span><span class="pl-c1">579885</span>)[<span class="pl-c1">1</span><span class="pl-k">:</span><span class="pl-c1">2</span>]</pre></div>
...
<div class="highlight highlight-r"><pre>pl_search()</pre></div>

<p>Locations only</p>

<div class="highlight highlight-r"><pre>pl_search_loc()</pre></div>

<p>Or you can submit a query:</p>

<div class="highlight highlight-r"><pre>pl_search_loc(<span class="pl-s"><span class="pl-pds">"</span>SELECT * FROM locations limit 5<span class="pl-pds">"</span></span>)</pre></div>

<p>Search names</p>

<div class="highlight highlight-r"><pre>pl_search_names(<span class="pl-s"><span class="pl-pds">"</span>SELECT * FROM names limit 5<span class="pl-pds">"</span></span>)</pre></div>

<p>Search places</p>

<div class="highlight highlight-r"><pre>pl_search_places(<span class="pl-s"><span class="pl-pds">"</span>SELECT * FROM places limit 5<span class="pl-pds">"</span></span>)</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.02958s from github-fe143-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
