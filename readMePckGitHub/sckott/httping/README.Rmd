...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>httping/README.Rmd at master · sckott/httping · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:4D95:6C88AE7:55105429" name="octolytics-dimension-request_id" />
...
<meta content="K0x+iFr4mJsdB0WGkHBx0wNKal8ccUSM7of8Z7LzCRqLkUJSly51P8B+H8bHmEymrkO4fn+ZlUSCWxy09LK5AQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fsckott%2Fhttping%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/sckott/httping/blob/dd1087e66bff24c78dffe41053e6bd41647fe3c3/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:9a560c991345c5c3aba9c587a5f26f7f -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/sckott/httping/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/sckott/httping/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/sckott/httping/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/sckott/httping/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/sckott/httping/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<ul>
<li>The web is increasingly a JSON world, so we set <code>content-type</code> and <code>accept</code> headers to <code>applications/json</code> by default </li>
<li>The workflow follows logically, or at least should, from, <em>hey, I got this url</em>, to <em>i need to add some options</em>, to <em>execute request</em>
</li>
<li>Whenever possible, we transform output to data.frame's - facilitating downstream manipulation via <code>dplyr</code>, etc.</li>
<li>We do <code>GET</code> requests by default. Specify a different type if you don't want <code>GET</code>
</li>
...
<p>All of the default just mentioned can be changed. </p>
...
attributes(<span class="pl-smi">res</span>)</pre></div>

<p>Or print a summary of a response, gives more detail</p>

<div class="highlight highlight-r"><pre><span class="pl-smi">res</span> %<span class="pl-k">&gt;</span>% summary()</pre></div>

<p>Messages are printed using <code>cat</code>, so you can suppress those using <code>verbose=FALSE</code>, like </p>

<div class="highlight highlight-r"><pre>GET(<span class="pl-s"><span class="pl-pds">"</span>http://google.com<span class="pl-pds">"</span></span>) %<span class="pl-k">&gt;</span>% time(<span class="pl-v">count</span><span class="pl-k">=</span><span class="pl-c1">3</span>, <span class="pl-v">verbose</span> <span class="pl-k">=</span> <span class="pl-c1">FALSE</span>)</pre></div>
...
<div class="highlight highlight-r"><pre><span class="pl-s"><span class="pl-pds">"</span>http://google.com<span class="pl-pds">"</span></span> %<span class="pl-k">&gt;</span>% ping()</pre></div>

<p>Or pass in additional arguments to modify request</p>

<div class="highlight highlight-r"><pre><span class="pl-s"><span class="pl-pds">"</span>http://google.com<span class="pl-pds">"</span></span> %<span class="pl-k">&gt;</span>% ping(<span class="pl-v">config</span><span class="pl-k">=</span>verbose())</pre></div>
...
<h2>
<a id="user-content-the-new-setup" class="anchor" href="#the-new-setup" aria-hidden="true"><span class="octicon octicon-link"></span></a>The new setup</h2>

<p>Default </p>

<div class="highlight highlight-r"><pre><span class="pl-s"><span class="pl-pds">"</span>http://api.crossref.org/works<span class="pl-pds">"</span></span> %<span class="pl-k">&gt;</span>%
  Get()</pre></div>

<p>Use query parameters</p>

<div class="highlight highlight-r"><pre><span class="pl-s"><span class="pl-pds">"</span>http://api.plos.org/search<span class="pl-pds">"</span></span> %<span class="pl-k">&gt;</span>%
  query(<span class="pl-v">q</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>*:*<span class="pl-pds">"</span></span>, <span class="pl-v">wt</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>json<span class="pl-pds">"</span></span>, <span class="pl-v">fl</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>id,journal,counter_total_all<span class="pl-pds">"</span></span>)</pre></div>

<p>Use body parameters</p>

<div class="highlight highlight-r"><pre><span class="pl-s"><span class="pl-pds">"</span>http://httpbin.org/put<span class="pl-pds">"</span></span> %<span class="pl-k">&gt;</span>%
  body(<span class="pl-v">x</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>hello world!<span class="pl-pds">"</span></span>)</pre></div>
</article>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03436s from github-fe124-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
