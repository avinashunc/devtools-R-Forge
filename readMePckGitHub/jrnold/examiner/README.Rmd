...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>examiner/README.Rmd at master · jrnold/examiner · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:54B6:6773F8D:5510418F" name="octolytics-dimension-request_id" />
...
<meta content="BaMJb+OvQTBrPduogWZu8cwTT/4vMkUpcSqdVEz7VGQj/YQVYzaSFvfZ13XTzCin3UUscoSzV7ktZ7NdvzF3eQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fjrnold%2Fexaminer%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/jrnold/examiner/blob/03d78c3b367dcedaa9a14ab9ac7838d869bacf17/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:83e60c5d643eb2844412653b72dc2a64 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/jrnold/examiner/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/jrnold/examiner/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/jrnold/examiner/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/jrnold/examiner/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/jrnold/examiner/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
    ...
    <article class="markdown-body entry-content" itemprop="mainContentOfPage"><div class="highlight highlight-r"><pre><span class="pl-smi">opts_chunk</span>[[<span class="pl-s"><span class="pl-pds">"</span>set<span class="pl-pds">"</span></span>]](<span class="pl-v">error</span> <span class="pl-k">=</span> <span class="pl-c1">FALSE</span>)
library(<span class="pl-s"><span class="pl-pds">"</span>stringr<span class="pl-pds">"</span></span>)</pre></div>
...
<pre lang="r,"><code>cat(paste0(readLines(system.file("yaml/questions.yaml", 
                                package = "examiner")),
    collapse = "\n"))
</code></pre>
...
<div class="highlight highlight-r"><pre>library(<span class="pl-s"><span class="pl-pds">"</span>examiner<span class="pl-pds">"</span></span>)
<span class="pl-smi">problems</span> <span class="pl-k">&lt;-</span> 
    problemset_from_yaml(system.file(<span class="pl-s"><span class="pl-pds">"</span>yaml/questions.yaml<span class="pl-pds">"</span></span>, 
                                     <span class="pl-v">package</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>examiner<span class="pl-pds">"</span></span>))
