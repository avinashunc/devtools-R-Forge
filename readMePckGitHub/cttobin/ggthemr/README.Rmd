...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>ggthemr/README.Rmd at master · cttobin/ggthemr · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:452F:68FD00F:55103821" name="octolytics-dimension-request_id" />
...
<meta content="xGYGGtmmKbkprA3xcVB8wWxaxA2wc4LNW0A6vsYzKa4tuilxjSCrZd33ZpHtFbVhmYuyyYNjPJsmYtDpkBXDog==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fcttobin%2Fggthemr%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/cttobin/ggthemr/blob/8f9ec298c3d890942e77b38d7fd090e41d55002a/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:53cbe6ffbfa13f953e4edf7b18b3a7f2 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/cttobin/ggthemr/blob/develop/README.Rmd"
               data-name="develop"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/cttobin/ggthemr/blob/gh-pages/README.Rmd"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/cttobin/ggthemr/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<include-fragment class="commit commit-loader file-history-tease" src="/cttobin/ggthemr/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/cttobin/ggthemr/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/cttobin/ggthemr/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/cttobin/ggthemr/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
    ...
    <article class="markdown-body entry-content" itemprop="mainContentOfPage"><div class="highlight highlight-r"><pre>suppressPackageStartupMessages(library(<span class="pl-smi">ggplot2</span>))
suppressPackageStartupMessages(library(<span class="pl-smi">gridExtra</span>))
library(<span class="pl-smi">ggthemr</span>)
<span class="pl-smi">example_plot</span> <span class="pl-k">&lt;-</span> ggplot(<span class="pl-smi">diamonds</span>, aes(<span class="pl-smi">price</span>, <span class="pl-v">fill</span> <span class="pl-k">=</span> <span class="pl-k">factor</span>(<span class="pl-smi">cut</span>))) <span class="pl-k">+</span> geom_histogram(<span class="pl-v">binwidth</span> <span class="pl-k">=</span> <span class="pl-c1">850</span>) <span class="pl-k">+</span> xlab(<span class="pl-s"><span class="pl-pds">'</span>Price (USD)<span class="pl-pds">'</span></span>) <span class="pl-k">+</span> ylab(<span class="pl-s"><span class="pl-pds">'</span>Count<span class="pl-pds">'</span></span>) <span class="pl-k">+</span> scale_x_continuous(<span class="pl-v">label</span> <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">x</span>) paste0(<span class="pl-smi">x</span> <span class="pl-k">/</span> <span class="pl-c1">1000</span>, <span class="pl-s"><span class="pl-pds">'</span>k<span class="pl-pds">'</span></span>)) <span class="pl-k">+</span> <span class="pl-k">list</span>(theme(<span class="pl-v">legend.position</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>none<span class="pl-pds">'</span></span>), scale_y_continuous(<span class="pl-v">label</span> <span class="pl-k">=</span> <span class="pl-k">function</span>(<span class="pl-smi">x</span>) format(<span class="pl-smi">x</span>, <span class="pl-v">big.mark</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>,<span class="pl-pds">"</span></span>, <span class="pl-v">scientific</span> <span class="pl-k">=</span> <span class="pl-c1">FALSE</span>)))</pre></div>
...
<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>camoflauge<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-chalk" class="anchor" href="#chalk" aria-hidden="true"><span class="octicon octicon-link"></span></a>chalk</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>chalk<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-copper" class="anchor" href="#copper" aria-hidden="true"><span class="octicon octicon-link"></span></a>copper</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>copper<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-dust" class="anchor" href="#dust" aria-hidden="true"><span class="octicon octicon-link"></span></a>dust</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>dust<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-earth" class="anchor" href="#earth" aria-hidden="true"><span class="octicon octicon-link"></span></a>earth</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>earth<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-fresh" class="anchor" href="#fresh" aria-hidden="true"><span class="octicon octicon-link"></span></a>fresh</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>fresh<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-grape" class="anchor" href="#grape" aria-hidden="true"><span class="octicon octicon-link"></span></a>grape</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grape<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-grass" class="anchor" href="#grass" aria-hidden="true"><span class="octicon octicon-link"></span></a>grass</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grass<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>
...
<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>greyscale<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-light" class="anchor" href="#light" aria-hidden="true"><span class="octicon octicon-link"></span></a>light</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>light<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-lilac" class="anchor" href="#lilac" aria-hidden="true"><span class="octicon octicon-link"></span></a>lilac</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>lilac<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-pale" class="anchor" href="#pale" aria-hidden="true"><span class="octicon octicon-link"></span></a>pale</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>pale<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-sea" class="anchor" href="#sea" aria-hidden="true"><span class="octicon octicon-link"></span></a>sea</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>sea<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>

<h3>
<a id="user-content-sky" class="anchor" href="#sky" aria-hidden="true"><span class="octicon octicon-link"></span></a>sky</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>sky<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>
...
<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>solarized<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>inner<span class="pl-pds">'</span></span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_theme()</pre></div>
...
<span class="pl-smi">example_plot</span> <span class="pl-k">+</span> ggtitle(<span class="pl-s"><span class="pl-pds">'</span>:(<span class="pl-pds">'</span></span>)
</pre></div>
...
<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grape<span class="pl-pds">'</span></span>, <span class="pl-v">layout</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>clean<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>
...
<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grape<span class="pl-pds">'</span></span>, <span class="pl-v">layout</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>clear<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>

<h3>
<a id="user-content-minimal" class="anchor" href="#minimal" aria-hidden="true"><span class="octicon octicon-link"></span></a>Minimal</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grape<span class="pl-pds">'</span></span>, <span class="pl-v">layout</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>minimal<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>

<h3>
<a id="user-content-plain" class="anchor" href="#plain" aria-hidden="true"><span class="octicon octicon-link"></span></a>Plain</h3>

<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grape<span class="pl-pds">'</span></span>, <span class="pl-v">layout</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>plain<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>
...
<div class="highlight highlight-r"><pre>  ggthemr(<span class="pl-s"><span class="pl-pds">'</span>grape<span class="pl-pds">'</span></span>, <span class="pl-v">layout</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>scientific<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0.5</span>)
  <span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>
...
<div class="highlight highlight-r"><pre>ggthemr(<span class="pl-s"><span class="pl-pds">'</span>earth<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">0</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>outer<span class="pl-pds">'</span></span>)
<span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>

<div class="highlight highlight-r"><pre>ggthemr(<span class="pl-s"><span class="pl-pds">'</span>earth<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">1</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>outer<span class="pl-pds">'</span></span>)
<span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>

<div class="highlight highlight-r"><pre>ggthemr(<span class="pl-s"><span class="pl-pds">'</span>earth<span class="pl-pds">'</span></span>, <span class="pl-v">spacing</span> <span class="pl-k">=</span> <span class="pl-c1">2</span>, <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>outer<span class="pl-pds">'</span></span>)
<span class="pl-e">ggthemr</span><span class="pl-k">:::</span>preview_layout()</pre></div>
...
<p>Squinting at a chart? Low on printer ink? ggthemr includes some methods to tweak charts to make them lighter or darker. Here's a standard theme:</p>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04622s from github-fe123-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
