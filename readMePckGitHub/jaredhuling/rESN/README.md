...
<!-- blob contrib key: blob_contributors:v21:5b3ef1af285ecf9157da51ce1d73b0e1 -->
...
<include-fragment class="commit commit-loader file-history-tease" src="/jaredhuling/rESN/contributors/master/README.md">
...
<p>U.train is the covariate matrix. Each row is an observation in time. Each column is a covariate.
...
lambda is the ridge regression tuning parameter</p>

<div class="highlight highlight-r"><pre>data(<span class="pl-smi">esn_data</span>)

<span class="pl-smi">net</span> <span class="pl-k">&lt;-</span> newESN(<span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">Y.train.noisy</span>,
              <span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">U.train</span>,
              <span class="pl-v">n.neurons</span> <span class="pl-k">=</span> <span class="pl-c1">1000</span>,
              <span class="pl-v">density</span> <span class="pl-k">=</span> <span class="pl-c1">0.02</span>,
              <span class="pl-v">back.density</span> <span class="pl-k">=</span> <span class="pl-c1">0.02</span>,
              <span class="pl-v">leak.rate</span> <span class="pl-k">=</span> <span class="pl-c1">0.6</span>,
              <span class="pl-v">lambda</span> <span class="pl-k">=</span> <span class="pl-c1">10</span>)

<span class="pl-smi">net</span> <span class="pl-k">&lt;-</span> train(<span class="pl-smi">net</span>)

<span class="pl-smi">ypred</span> <span class="pl-k">&lt;-</span> predict(<span class="pl-smi">net</span>, <span class="pl-v">u</span> <span class="pl-k">=</span> <span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">U.test</span>)

<span class="pl-smi">range</span> <span class="pl-k">&lt;-</span> <span class="pl-c1">431</span><span class="pl-k">:</span><span class="pl-c1">480</span>
<span class="pl-smi">all</span> <span class="pl-k">&lt;-</span> c(<span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">Y.test.noisy</span>[<span class="pl-smi">range</span>,<span class="pl-c1">1</span>], <span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">Y.true.test</span>[<span class="pl-smi">range</span>,<span class="pl-c1">1</span>],
         <span class="pl-smi">ypred</span>[<span class="pl-smi">range</span>])
plot(<span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">Y.test.noisy</span>[<span class="pl-smi">range</span>,<span class="pl-c1">1</span>], <span class="pl-v">type</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>l<span class="pl-pds">"</span></span>, <span class="pl-v">lwd</span> <span class="pl-k">=</span> <span class="pl-c1">5</span>, <span class="pl-v">ylim</span> <span class="pl-k">=</span> range(<span class="pl-smi">all</span>), <span class="pl-v">col</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>green<span class="pl-pds">"</span></span>)
lines(<span class="pl-smi">ypred</span>[<span class="pl-smi">range</span>], <span class="pl-v">col</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>blue<span class="pl-pds">"</span></span>, <span class="pl-v">lwd</span> <span class="pl-k">=</span> <span class="pl-c1">3</span>)
lines(<span class="pl-smi">example_data</span><span class="pl-k">$</span><span class="pl-smi">Y.test.signal</span>[<span class="pl-smi">range</span>,<span class="pl-c1">1</span>], <span class="pl-v">col</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>black<span class="pl-pds">"</span></span>, <span class="pl-v">lwd</span> <span class="pl-k">=</span> <span class="pl-c1">5</span>)

legend(<span class="pl-s"><span class="pl-pds">"</span>bottomleft<span class="pl-pds">"</span></span>, <span class="pl-v">inset</span><span class="pl-k">=</span><span class="pl-c1">0.01</span>, <span class="pl-v">legend</span><span class="pl-k">=</span>c(<span class="pl-s"><span class="pl-pds">"</span>Noisy (observed) seq<span class="pl-pds">"</span></span>,<span class="pl-s"><span class="pl-pds">"</span>ESN Prediction<span class="pl-pds">"</span></span>,<span class="pl-s"><span class="pl-pds">"</span>True Signal<span class="pl-pds">"</span></span>),
