...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>simmer/README.Rmd at master · Bart6114/simmer · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC101:6669:1ADEA84:55104A3C" name="octolytics-dimension-request_id" />
...
<meta content="SwcXusjoZ5VNks1xq0nGv+Pzm/YT0/9ZZror4RtA62fa/zXHqdF2BIxGh1/rIP18OnYCmN7uu8yBVDLdxESQrQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2FBart6114%2Fsimmer%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/Bart6114/simmer/blob/6620ac9894eff0e58324be9fd1e46f1eb9e79a34/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:8e04e19ef85b2c7040ed5532af165070 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/Bart6114/simmer/blob/dev/README.Rmd"
               data-name="dev"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/Bart6114/simmer/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/Bart6114/simmer/tree/v2.0/README.Rmd"
                 data-name="v2.0"
                 data-skip-pjax="true"
                 rel="nofollow"
...
<include-fragment class="commit commit-loader file-history-tease" src="/Bart6114/simmer/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/Bart6114/simmer/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/Bart6114/simmer/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/Bart6114/simmer/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
</table><p><a href="https://travis-ci.org/Bart6114/simmer"><img src="https://camo.githubusercontent.com/c24f2e0dd6237538da0122d13d0f9eedfc9f117c/68747470733a2f2f7472617669732d63692e6f72672f42617274363131342f73696d6d65722e7376673f6272616e63683d6d6173746572" alt="Build Status" data-canonical-src="https://travis-ci.org/Bart6114/simmer.svg?branch=master" style="max-width:100%;"></a></p>
...
<div class="highlight highlight-r"><pre>library(<span class="pl-smi">ggthemr</span>)
ggthemr(<span class="pl-s"><span class="pl-pds">'</span>fresh<span class="pl-pds">'</span></span>, <span class="pl-v">layout</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">"</span>scientific<span class="pl-pds">"</span></span>)</pre></div>
...
<pre lang="r,"><code>devtools::install_github("Bart6114/simmer")
</code></pre>
...
<pre lang="r,"><code>library(simmer)
</code></pre>
...
<div class="highlight highlight-r"><pre><span class="pl-smi">t0</span><span class="pl-k">&lt;-</span>
  ...
  add_release_event(<span class="pl-s"><span class="pl-pds">"</span>administration<span class="pl-pds">"</span></span>,<span class="pl-c1">1.0</span>)
...
<span class="pl-smi">sim</span><span class="pl-k">&lt;-</span>
  ...
  add_resource(<span class="pl-s"><span class="pl-pds">"</span>administration<span class="pl-pds">"</span></span>, <span class="pl-c1">1</span>)
</pre></div>
...
<span class="pl-smi">sim</span><span class="pl-k">&lt;-</span>
  <span class="pl-smi">sim</span> %<span class="pl-k">&gt;</span>%
  add_entity(<span class="pl-v">trajectory</span> <span class="pl-k">=</span> <span class="pl-smi">t1</span>, <span class="pl-v">name</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>separate_patient<span class="pl-pds">"</span></span> , <span class="pl-v">activation_time</span> <span class="pl-k">=</span>  <span class="pl-c1">100</span>)
</pre></div>
...
<div class="highlight highlight-r"><pre><span class="pl-smi">t2</span><span class="pl-k">&lt;-</span>
  ...
  add_timeout_event(<span class="pl-c1">15</span>) %<span class="pl-k">&gt;</span>%
  add_timeout_event(<span class="pl-c1">5</span>)
...
<pre lang="r,"><code>plot_resource_utilization(sim, c("nurse", "doctor","administration"))
</code></pre>

<p>It is also possible to have a look at a specific resource and its activity during the simulation.</p>

<pre lang="r,"><code>plot_resource_usage(sim, "doctor")
</code></pre>
...
<pre lang="r,"><code>plot_resource_usage(sim, "doctor", 6)
</code></pre>

<p>One can also query the raw resource monitor data.</p>

<pre lang="r,"><code>head(
...
<pre lang="r,"><code>plot_evolution_entity_times(sim, type = "flow_time")
</code></pre>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04604s from github-fe124-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
