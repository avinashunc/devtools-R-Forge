...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>separation/README.Rmd at master · carlislerainey/separation · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC101:6669:1B2391E:55104EFB" name="octolytics-dimension-request_id" />
...
<meta content="Yj8eLytF01Pm/GGT+ZAODYlCUnPNEujFaX/f+7Ueg8wzBbFaroTQJow56a2fjwak39tK/R27Z+QoS/6Cn0exjw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fcarlislerainey%2Fseparation%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/carlislerainey/separation/blob/b6a35bafe33b7850ca787e6e14a96ba961629da0/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:56588a1334aafd6e9ec63566eadc1904 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/carlislerainey/separation/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/carlislerainey/separation/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/carlislerainey/separation/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/carlislerainey/separation/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/carlislerainey/separation/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
</table><p>This is the beginnings of an R packages that implements the ideas in my
...
<pre lang="r,"><code>devtools::install_github("carlislerainey/compactr")
...
library(<span class="pl-smi">texreg</span>)  <span class="pl-c"># for screenreg, which neatly prints the results</span>
screenreg(<span class="pl-smi">m</span>)</pre></div>
...
<span class="pl-smi">pppd_inf</span> <span class="pl-k">&lt;-</span> calc_pppd(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, <span class="pl-v">prior_sims</span> <span class="pl-k">=</span> <span class="pl-smi">normal_3</span>,     
                   <span class="pl-v">sep_var_name</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>gop_governor<span class="pl-pds">"</span></span>, <span class="pl-v">prior_label</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>Normal(0, 3)<span class="pl-pds">"</span></span>)
</pre></div>
...
<div class="highlight highlight-r"><pre>mean(<span class="pl-smi">pppd_inf</span><span class="pl-k">$</span><span class="pl-smi">pr</span> <span class="pl-k">&lt;</span> <span class="pl-c1">0.01</span>)
mean(<span class="pl-smi">pppd_inf</span><span class="pl-k">$</span><span class="pl-smi">pr</span> <span class="pl-k">&lt;</span> <span class="pl-c1">0.001</span>)</pre></div>
...
<div class="highlight highlight-r"><pre>
<span class="pl-c"># simulate from potential skeptical and enthusiastic priors</span>
set.seed(<span class="pl-c1">1234</span>)
...
plot(<span class="pl-smi">pppds</span>)
plot(<span class="pl-smi">pppds</span>, <span class="pl-v">log_scale</span> <span class="pl-k">=</span> <span class="pl-c1">TRUE</span>)</pre></div>
...
<span class="pl-smi">post_inf</span> <span class="pl-k">&lt;-</span> sim_post_normal(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
                            ...
                            <span class="pl-v">n_sims</span> <span class="pl-k">=</span> <span class="pl-c1">1000</span>)
<span class="pl-smi">post_enth</span> <span class="pl-k">&lt;-</span> sim_post_normal(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
                            ...
                            <span class="pl-v">n_sims</span> <span class="pl-k">=</span> <span class="pl-c1">1000</span>)
<span class="pl-smi">post_skep</span> <span class="pl-k">&lt;-</span> sim_post_normal(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
...
<div class="highlight highlight-r"><pre>
<span class="pl-smi">posts</span> <span class="pl-k">&lt;-</span> combine_post(<span class="pl-smi">post_skep</span>, <span class="pl-smi">post_inf</span>, <span class="pl-smi">post_enth</span>)
plot(<span class="pl-smi">posts</span>, <span class="pl-v">var_name</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>gop_governor<span class="pl-pds">"</span></span>)
</pre></div>
...
<div class="highlight highlight-r"><pre>
<span class="pl-smi">X_pred_list</span> <span class="pl-k">&lt;-</span> set_at_median(<span class="pl-smi">f</span>, <span class="pl-smi">politics_and_need</span>)
...
<div class="highlight highlight-r"><pre>plot_hyp_test(<span class="pl-smi">posts</span>, <span class="pl-s"><span class="pl-pds">"</span>gop_governor<span class="pl-pds">"</span></span>, <span class="pl-v">research_hyp</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>+<span class="pl-pds">"</span></span>, <span class="pl-v">xlab</span> <span class="pl-k">=</span> expression(Pr(<span class="pl-smi">beta</span>[<span class="pl-smi">GOP</span><span class="pl-k">~</span><span class="pl-smi">Gov</span>] <span class="pl-k">&gt;</span> <span class="pl-c1">0</span>)))
plot_hyp_test(<span class="pl-smi">posts</span>, <span class="pl-s"><span class="pl-pds">"</span>percent_uninsured<span class="pl-pds">"</span></span>, <span class="pl-v">research_hyp</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>-<span class="pl-pds">"</span></span>, <span class="pl-v">xlab</span> <span class="pl-k">=</span> expression(Pr(<span class="pl-smi">beta</span>[<span class="pl-smi">Uninsured</span>] <span class="pl-k">&gt;</span> <span class="pl-c1">0</span>)))</pre></div>
...
<div class="highlight highlight-r"><pre>
<span class="pl-smi">gg_inf</span> <span class="pl-k">&lt;-</span> <span class="pl-k">data.frame</span>(<span class="pl-smi">qi_inf</span><span class="pl-k">$</span><span class="pl-smi">fn_args</span><span class="pl-k">$</span><span class="pl-smi">post</span><span class="pl-k">$</span><span class="pl-smi">prior</span>, <span class="pl-smi">qi_inf</span><span class="pl-k">$</span><span class="pl-smi">qi_sims</span>)
...
<div class="highlight highlight-r"><pre>
library(<span class="pl-smi">arm</span>)
<span class="pl-smi">politics_and_need</span><span class="pl-k">$</span><span class="pl-smi">std_percent_uninsured</span> <span class="pl-k">&lt;-</span> rescale(<span class="pl-smi">politics_and_need</span><span class="pl-k">$</span><span class="pl-smi">percent_uninsured</span>)
...
<span class="pl-smi">post_inf_std</span> <span class="pl-k">&lt;-</span> sim_post_normal(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
                            <span class="pl-v">sep_var</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>gop_governor<span class="pl-pds">"</span></span>, <span class="pl-v">sd</span> <span class="pl-k">=</span> <span class="pl-c1">3</span>, 
                            <span class="pl-v">n_sims</span> <span class="pl-k">=</span> <span class="pl-c1">1000</span>)
<span class="pl-smi">post_enth_std</span> <span class="pl-k">&lt;-</span> sim_post_normal(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
                            <span class="pl-v">sep_var</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>gop_governor<span class="pl-pds">"</span></span>, <span class="pl-v">sd</span> <span class="pl-k">=</span> <span class="pl-c1">9</span>, 
                            <span class="pl-v">n_sims</span> <span class="pl-k">=</span> <span class="pl-c1">1000</span>)
<span class="pl-smi">post_skep_std</span> <span class="pl-k">&lt;-</span> sim_post_normal(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
                            <span class="pl-v">sep_var</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>gop_governor<span class="pl-pds">"</span></span>, <span class="pl-v">sd</span> <span class="pl-k">=</span> <span class="pl-c1">1.5</span>, 
                            <span class="pl-v">n_sims</span> <span class="pl-k">=</span> <span class="pl-c1">1000</span>)
<span class="pl-smi">post_jeffreys_std</span> <span class="pl-k">&lt;-</span> sim_post_jeffreys(<span class="pl-smi">f</span>, <span class="pl-v">data</span> <span class="pl-k">=</span> <span class="pl-smi">politics_and_need</span>, 
                            <span class="pl-v">n_sims</span> <span class="pl-k">=</span> <span class="pl-c1">5000</span>)

data(<span class="pl-smi">politics_and_need_rescaled</span>)
...
<span class="pl-c"># posts &lt;- combine_post(post_skep_std, post_inf_std, post_enth_std, </span>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03716s from github-fe143-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
