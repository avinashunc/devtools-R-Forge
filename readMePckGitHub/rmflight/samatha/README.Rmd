...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>samatha/README.Rmd at master · rmflight/samatha · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC101:666A:2BF4C3C:55103760" name="octolytics-dimension-request_id" />
...
<meta content="yCQ0lXfxYv3NSn7E0N/jeyurnTs3eCZVMgAciMMvJp3CFe41F8h7D1nc05fWYSyKKsMGFyLnIIF8RHPP/s0bQw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Frmflight%2Fsamatha%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/rmflight/samatha/blob/660bf4183c0c6e6d4897bc253e9bbc96242d6913/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:027c33ffc7ca99712c3befca6b7b2ed8 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/2partPage/README.Rmd"
               data-name="2partPage"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/devel/README.Rmd"
               data-name="devel"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/engine/README.Rmd"
               data-name="engine"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/fixRSS/README.Rmd"
               data-name="fixRSS"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/fixRebuild/README.Rmd"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/fixTitle/README.Rmd"
               data-name="fixTitle"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/listPages/README.Rmd"
               data-name="listPages"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/rmflight/samatha/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/numposts/README.Rmd"
               data-name="numposts"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/pages_posts_separate/README.Rmd"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/resourcesAvailable/README.Rmd"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/separateMdRmd/README.Rmd"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/tagsInPost/README.Rmd"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/titleType/README.Rmd"
               data-name="titleType"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/rmflight/samatha/blob/useRserve/README.Rmd"
               data-name="useRserve"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<include-fragment class="commit commit-loader file-history-tease" src="/rmflight/samatha/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/rmflight/samatha/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/rmflight/samatha/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/rmflight/samatha/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<pre lang="r,"><code># check install_github()
require(devtools)
...
<pre lang="r,"><code>library(samatha)
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.05935s from github-fe116-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
