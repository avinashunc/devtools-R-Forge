...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>traits/README.Rmd at master · ropensci/traits · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:452F:6B14625:55104A5A" name="octolytics-dimension-request_id" />
...
<meta content="k9aEZVmdzrslWWcxXgSBa8XJ+9z7FhQtJD6fXLxW+K/bhQ0+Z5SmFJCeXlduRrIYiUor/g+RUqE4NN+/FDxD+g==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fropensci%2Ftraits%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/ropensci/traits/blob/6471049ed8c63ff4f80997df3622612e45cab48c/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:60cfd8b61a44ad0bde7cf2b41af76d04 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/ropensci/traits/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
...
<include-fragment class="commit commit-loader file-history-tease" src="/ropensci/traits/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/ropensci/traits/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/ropensci/traits/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/ropensci/traits/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<li>
<a href="http://www.betydb.org">BETYdb</a> - <code>betydb_</code>
</li>
<li>
...
<p>Function setup: plural functions like <code>betydb_traits()</code> accept parameters and always give back a data.frame, while singlur function names accept an ID and give back a list. </p>
...
<div class="highlight highlight-r"><pre>(<span class="pl-smi">out</span> <span class="pl-k">&lt;-</span> betydb_traits(<span class="pl-v">genus</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>Miscanthus<span class="pl-pds">"</span></span>, <span class="pl-v">species</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>giganteus<span class="pl-pds">"</span></span>))</pre></div>
...
<span class="pl-smi">out</span> %<span class="pl-k">&gt;</span>%
  ...
  arrange(desc(<span class="pl-smi">mean_result</span>))</pre></div>

<p>Single trait</p>

<div class="highlight highlight-r"><pre>betydb_trait(<span class="pl-v">id</span> <span class="pl-k">=</span> <span class="pl-c1">10</span>)</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03805s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
