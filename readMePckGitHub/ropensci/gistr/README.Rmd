...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>gistr/README.Rmd at master · ropensci/gistr · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC101:6668:E4E91C:5510433B" name="octolytics-dimension-request_id" />
...
<meta content="Cjb8snPdrHQG1mW9DFHAsZKrHIXgxCjnOEFuHFYeJkUNfb3GlvMKSfJxGQEi6xlRfXGijtDx9MSVl+CM0A40rw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fropensci%2Fgistr%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/ropensci/gistr/blob/80c7aa7560a6184ed7f25ae596b45d788ed2e94d/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:c24cd330762fe6c38d87f5a16a969236 -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/ropensci/gistr/blob/dev/README.Rmd"
               data-name="dev"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/ropensci/gistr/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/ropensci/gistr/tree/v0.1.0/README.Rmd"
                 data-name="v0.1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/ropensci/gistr/tree/v0.1/README.Rmd"
                 data-name="v0.1"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
  ...
  <div class="breadcrumb js-zeroclipboard-target">
    <span class='repo-root js-repo-root'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/ropensci/gistr" class="" data-branch="master" data-direction="back" data-pjax="true" itemscope="url"><span itemprop="title">gistr</span></a></span></span><span class="separator">/</span><strong class="final-path">README.Rmd</strong>
  </div>
</div>

<include-fragment class="commit commit-loader file-history-tease" src="/ropensci/gistr/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/ropensci/gistr/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/ropensci/gistr/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/ropensci/gistr/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
...
<div class="highlight highlight-r"><pre>library(<span class="pl-s"><span class="pl-pds">"</span>gistr<span class="pl-pds">"</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>rate_limit()</pre></div>
...
<div class="highlight highlight-r"><pre>gists(<span class="pl-v">per_page</span> <span class="pl-k">=</span> <span class="pl-c1">2</span>)</pre></div>

<p>Since a certain date/time</p>

<div class="highlight highlight-r"><pre>gists(<span class="pl-v">since</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>2014-05-26T00:00:00Z<span class="pl-pds">'</span></span>, <span class="pl-v">per_page</span> <span class="pl-k">=</span> <span class="pl-c1">2</span>)</pre></div>

<p>Request different types of gists, one of public, minepublic, mineall, or starred.</p>

<div class="highlight highlight-r"><pre>gists(<span class="pl-s"><span class="pl-pds">'</span>minepublic<span class="pl-pds">'</span></span>, <span class="pl-v">per_page</span> <span class="pl-k">=</span> <span class="pl-c1">2</span>)</pre></div>
...
<div class="highlight highlight-r"><pre>gist(<span class="pl-v">id</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">'</span>f1403260eb92f5dfa7e1<span class="pl-pds">'</span></span>)</pre></div>
...
gist_create(<span class="pl-smi">file</span>, <span class="pl-v">description</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>a new cool gist<span class="pl-pds">'</span></span>, <span class="pl-v">browse</span> <span class="pl-k">=</span> <span class="pl-c1">FALSE</span>)</pre></div>
...
<span class="pl-s"></span>
<span class="pl-s">[1] 0.3229318 0.5933054 0.7778408 0.3898947 0.1309717 0.7501378 0.3206379 0.3379005</span>
<span class="pl-s"><span class="pl-pds">'</span></span>}, <span class="pl-v">browse</span><span class="pl-k">=</span><span class="pl-c1">FALSE</span>)</pre></div>
...
<div class="highlight highlight-r"><pre><span class="pl-smi">file</span> <span class="pl-k">&lt;-</span> system.file(<span class="pl-s"><span class="pl-pds">"</span>examples<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>stuff.Rmd<span class="pl-pds">"</span></span>, <span class="pl-v">package</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>gistr<span class="pl-pds">"</span></span>)
run(<span class="pl-smi">file</span>, <span class="pl-v">knitopts</span> <span class="pl-k">=</span> <span class="pl-k">list</span>(<span class="pl-v">quiet</span><span class="pl-k">=</span><span class="pl-c1">TRUE</span>)) %<span class="pl-k">&gt;</span>% gist_create(<span class="pl-v">browse</span> <span class="pl-k">=</span> <span class="pl-c1">FALSE</span>)</pre></div>

<div class="highlight highlight-r"><pre>gists(<span class="pl-s"><span class="pl-pds">'</span>minepublic<span class="pl-pds">'</span></span>)[[<span class="pl-c1">1</span>]] %<span class="pl-k">&gt;</span>% <span class="pl-smi">delete</span></pre></div>
...
<div class="highlight highlight-r"><pre>gists()[[<span class="pl-c1">1</span>]] %<span class="pl-k">&gt;</span>% commits()</pre></div>
...
<div class="highlight highlight-r"><pre>gist(<span class="pl-s"><span class="pl-pds">'</span>7ddb9810fc99c84c65ec<span class="pl-pds">'</span></span>) %<span class="pl-k">&gt;</span>% star()</pre></div>

<p>Unstar</p>

<div class="highlight highlight-r"><pre>gist(<span class="pl-s"><span class="pl-pds">'</span>7ddb9810fc99c84c65ec<span class="pl-pds">'</span></span>) %<span class="pl-k">&gt;</span>% unstar()</pre></div>
...
<div class="highlight highlight-r"><pre>gists()[[<span class="pl-c1">1</span>]] %<span class="pl-k">&gt;</span>% embed()</pre></div>
...
<div class="highlight highlight-r"><pre>gist(<span class="pl-v">id</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>1642874<span class="pl-pds">'</span></span>) %<span class="pl-k">&gt;</span>% forks(<span class="pl-v">per_page</span><span class="pl-k">=</span><span class="pl-c1">2</span>)</pre></div>
...
(<span class="pl-smi">forked</span> <span class="pl-k">&lt;-</span> <span class="pl-smi">g</span>[[ sample(seq_along(<span class="pl-smi">g</span>), <span class="pl-c1">1</span>) ]] %<span class="pl-k">&gt;</span>% fork())</pre></div>

<div class="highlight highlight-r"><pre>gist(<span class="pl-smi">forked</span><span class="pl-k">$</span><span class="pl-smi">id</span>) %<span class="pl-k">&gt;</span>% delete()</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.02731s from github-fe122-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
