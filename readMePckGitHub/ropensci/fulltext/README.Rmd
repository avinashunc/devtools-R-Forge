...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>fulltext/README.Rmd at master · ropensci/fulltext · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="C1BEC102:452F:6AC3280:55104765" name="octolytics-dimension-request_id" />
...
<meta content="OLZJJT7mEEV5lvNaNTPvhFkErCHvGtAz8zGnR9Di77PMPG5oedZimYnZfAUUpOGBtQU7fh5P4yJE1kub9AGMkw==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fropensci%2Ffulltext%2Fblob%2Fmaster%2FREADME.Rmd" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/ropensci/fulltext/blob/d8a7f84bd72e85d182f71bf1b158a70346aa4c8d/README.Rmd" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:cf53412e47f4932ddab2b16db39d66d0 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/ropensci/fulltext/blob/biorxiv/README.Rmd"
               data-name="biorxiv"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/ropensci/fulltext/blob/extract/README.Rmd"
               data-name="extract"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/ropensci/fulltext/blob/master/README.Rmd"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<include-fragment class="commit commit-loader file-history-tease" src="/ropensci/fulltext/contributors/master/README.Rmd">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/ropensci/fulltext/raw/master/README.Rmd" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/ropensci/fulltext/blame/master/README.Rmd" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/ropensci/fulltext/commits/master/README.Rmd" class="btn btn-sm " rel="nofollow">History</a>
      </div>
    ...
    <article class="markdown-body entry-content" itemprop="mainContentOfPage"><div class="highlight highlight-r"><pre><span class="pl-e">knitr</span><span class="pl-k">::</span><span class="pl-smi">opts_chunk</span><span class="pl-k">$</span>set(
...
<div class="highlight highlight-r"><pre>ft_search(<span class="pl-v">query</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>ecology<span class="pl-pds">'</span></span>, <span class="pl-v">from</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>plos<span class="pl-pds">'</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>ft_get(<span class="pl-v">ids</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>10.1371/journal.pone.0086169<span class="pl-pds">'</span></span>, <span class="pl-v">from</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">'</span>plos<span class="pl-pds">'</span></span>)</pre></div>
...
<div class="highlight highlight-r"><pre>(<span class="pl-smi">res_rcamp</span> <span class="pl-k">&lt;-</span> ft_extract(<span class="pl-smi">pdf1</span>, <span class="pl-s"><span class="pl-pds">"</span>rcamp<span class="pl-pds">"</span></span>))</pre></div>

<p>Using <code>ghostscript</code></p>

<div class="highlight highlight-r"><pre>(<span class="pl-smi">res_gs</span> <span class="pl-k">&lt;-</span> ft_extract(<span class="pl-smi">pdf1</span>, <span class="pl-s"><span class="pl-pds">"</span>gs<span class="pl-pds">"</span></span>))</pre></div>

<p>Using <code>xpdf</code></p>

<div class="highlight highlight-r"><pre>(<span class="pl-smi">res_xpdf</span> <span class="pl-k">&lt;-</span> ft_extract(<span class="pl-smi">pdf1</span>, <span class="pl-s"><span class="pl-pds">"</span>xpdf<span class="pl-pds">"</span></span>))</pre></div>
...
(<span class="pl-smi">corpus_rcamp</span> <span class="pl-k">&lt;-</span> ft_extract_corpus(<span class="pl-smi">paths</span>, <span class="pl-s"><span class="pl-pds">"</span>rcamp<span class="pl-pds">"</span></span>))</pre></div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03592s from github-fe132-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
